    ...
    <div className="page-home ac-nav-overlap globalnav-scrim globalheader-dark">
                        ...
                        <div className="globalnav-flyout-content globalnav-submenu-content" style={{ '--r-globalnav-flyout-elevated-group-count': 1, '--r-globalnav-flyout-group-total': 2, '--r-globalnav-flyout-item-total': 9 }}>
                          ...
                          <div className="globalnav-submenu-group" data-analytics-region="shop special stores" style={{ '--r-globalnav-flyout-group-number': 2 }}>
                            ...
                            <ul className="globalnav-submenu-list" aria-labelledby="68805228">
                              ...
                              <li className="globalnav-submenu-list-item" style={{ '--r-globalnav-flyout-item-number': 5 }}>
                                <a href="/us/shop/goto/eppstore/veteransandmilitary" className="globalnav-submenu-link" data-analytics-title="veterans and military">Veterans and Military</a>
                              </li>
                            </ul>
                          </div>
                        </div>
              ...
              <div id="tv-plus-gallery-item-8" data-analytics-gallery-item-id="Tv Plus Gallery item 8" data-ac-gallery-item="" className="gallery-item theme-dark" role="tabpanel" aria-labelledby="tv-plus-gallery-item-8-trigger" data-original-aria-hidden="" aria-hidden="true" style={{ '--progress': 7, zIndex: 0, opacity: 1, transform: 'translate(8855px, 0px)' }}>
                <a href="https://tv.apple.com/us/movie/the-lost-bus/umc.cmc.4p7gv4trt1rt0kuiwzmitibiv?l=en-US?itscg=10000&amp;itsct=atv-apl_hp-stream_now--220622" style={{ backgroundImage: 'url(https://is1-ssl.mzstatic.com/image/thumb/9dce-B0hUgREvlPfPw7ZFA/1250x703.jpg)' }} data-analytics-title="stream now" data-rid-relay="{&quot;289&quot;:&quot;itsct&quot;}" data-analytics-exit-link="" data-analytics-activitymap-region-id="tv-plus-gallery-the lost bus" data-original-tabindex="" tabIndex="-1">
                  <div className="inner">
                    <div className="info-top">
                      <figure className="atv-plus-icon show-icon"></figure>
                      <figure className="logo" style={{ backgroundImage: 'url(https://is1-ssl.mzstatic.com/image/thumb/Xs3X8rHYUINAAfollowers50X@73eg/548x160.png)' }}></figure>
                    </div>
                    <div className="info-bottom">
                      <div className="custom-button button-primary-light" aria-label="Stream now, The Lost Bus">Stream now</div>
                      <p className="typography-shows-genre"><span className="genre">Drama</span> <span className="m-dot" aria-hidden="true">·</span> Lost and found.</p>
                    </div>
                  </div>
                </a>
              </div>
                  ...
                  <div className="fam-gallery-marquee" data-anim-time-group="famGalleryMarquee" style={{ transform: "matrix(1, 0, 0, 1, 0, 0)" }}>
                      ...
                      <div className="fam-gallery-item fgi-clone" data-gallery-id="ra.1807563289" data-analytics-gallery-item-id="fam-gallery-item-2" data-ac-gallery-item="" data-gallery-item-theme="dark">
                          <a className="fam-gallery-link" data-analytics-title="listen now - seth rogen: the zane lowe interview" data-analytics-exit-link="" data-rid-relay='{"286":"itsct"}' href="https://music.apple.com/us/station/seth-rogen-the-zane-lowe-interview/ra.1807563289?itscg=10000&amp;itsct=am-apl_hp-listen_now--240326">
                              <div className="fam-gallery-bg-music" style={{ backgroundColor: "rgb(38,38,38)" }} data-fam-lazy-image="">
                      ...
                      <div className="fam-gallery-item fgi-clone" data-gallery-id="1785344154" data-analytics-gallery-item-id="fam-gallery-item-4" data-ac-gallery-item="" data-gallery-item-theme="dark">
                          <a className="fam-gallery-link" data-analytics-title="watch now - strength with gregg" data-analytics-exit-link="" data-rid-relay='{"299":"itsct"}' href="https://fitness.apple.com/us/workout/strength-with-gregg/1785344154?itscg=10000&amp;itsct=afp-apl_hp-watch_now--240326">
                              <div className="fam-gallery-bg fam-gallery-bg-4 fam-gallery-bg-6" style={{ backgroundColor: "#0a0303" }} data-fam-lazy-image="">
                                  <div className="fam-gallery-logo fam-gallery-logo-fitness is-theme-light">
                                      <svg viewBox="0 0 449 80">
                                          <path d="M78.6,78.56V5.5h45.62v9.77H89.94v23.14h31.39v9.57H89.94v30.58H78.6z M131.86,11.22c0-3.49,2.83-6.28,6.33-6.28 c3.49,0,6.33,2.79,6.33,6.28c0,3.44-2.83,6.28-6.33,6.28C134.69,17.5,131.86,14.67,131.86,11.22z M132.72,25.3h10.94v53.26h-10.94 V25.3z M170.68,12.69V25.3h10.12v8.66h-10.12v29.36c0,4.61,2.02,6.68,6.48,6.68c1.11,0,2.89-0.1,3.59-0.25v8.66 c-1.21,0.3-3.64,0.51-6.08,0.51c-10.78,0-14.99-4.1-14.99-14.38V33.96h-7.75V25.3h7.75V12.69H170.68z M189.98,25.3h10.43v8.91h0.25 c2.89-6.08,8.56-9.82,16.76-9.82c11.75,0,18.48,7.49,18.48,19.69v34.48h-10.99V46.21c0-8-3.75-12.4-11.34-12.4 c-7.7,0-12.66,5.47-12.66,13.72v31.04h-10.94V25.3z M291.07,62.91c-1.52,9.72-10.73,16.66-22.93,16.66 c-15.64,0-25.11-10.58-25.11-27.39c0-16.71,9.62-27.85,24.66-27.85c14.78,0,24,10.43,24,26.58v3.75h-37.62v0.66 c0,9.26,5.57,15.39,14.33,15.39c6.23,0,10.84-3.14,12.3-7.8H291.07z M254.11,47.02h26.63c-0.25-8.15-5.42-13.87-13.06-13.87 C260.03,33.15,254.66,38.97,254.11,47.02z M319.62,24.34c12.4,0,20.45,6.89,20.81,16.71h-10.28c-0.61-5.16-4.4-8.4-10.53-8.4 c-5.92,0-9.87,2.89-9.87,7.14c0,3.34,2.43,5.62,8.2,6.94l8.66,1.97c10.89,2.53,15.04,6.78,15.04,14.48c0,9.72-9.06,16.4-21.62,16.4 c-13.32,0-21.32-6.53-22.33-16.66h10.83c1.01,5.57,4.81,8.3,11.49,8.3c6.58,0,10.63-2.73,10.63-7.09c0-3.44-1.97-5.47-7.8-6.79l-8.66-2.02 c-10.13-2.33-15.14-7.19-15.14-14.94C348.52,30.87,356.83,24.34,369.08,24.34z M428.07,78.63h-9.97V56.93h-20.66v-9.87h20.66V25.37 h9.97v21.69h20.71v9.87h-20.71V78.63z M43.87,12.7c2.73-3.42,4.59-8.01,4.1-12.7c-4,0.2-8.88,2.64-11.71,6.06c-2.54,2.93-4.78,7.71-4.2,12.21C36.55,18.66,41.04,16.02,43.87,12.7 M47.92,19.14c-6.52-0.39-12.07,3.7-15.18,3.7c-3.12,0-7.89-3.51-13.04-3.41c-6.71,0.1-12.94,3.89-16.35,9.93c-7.01,12.08-1.85,30,4.97,39.83 c3.31,4.87,7.3,10.23,12.55,10.03c4.97-0.19,6.91-3.22,12.95-3.22c6.03,0,7.78,3.22,13.04,3.12c5.45-0.1,8.86-4.87,12.17-9.74 c3.8-5.55,5.35-10.91,5.45-11.2c-0.1-0.1-10.51-4.09-10.61-16.07c-0.1-10.03,8.18-14.8,8.56-15.1C57.75,20.12,50.45,19.34,47.92,19.14"></path>
                                      </svg>
                                  </div>
                                  <div className="fam-gallery-overlay">
                                      <span className="fam-gallery-button button button-primary-light">Watch now</span>
      ...
      <section className="ac-gf-footer">
      	...
      	<div className="ac-gf-footer-legal">
      		<div className="ac-gf-footer-legal-copyright">Copyright © 2025 Apple Inc. All rights reserved.</div>
      			...
      			<div className="ac-gf-directory-column">
      				<div className="ac-gf-directory-column-section">
      					...
      					<ul id="footer-directory-column-section-products" className="ac-gf-directory-column-section-list" role="list">
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/us/shop/goto/store" data-analytics-title="store">Store</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/mac/" data-analytics-title="mac">Mac</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/ipad/" data-analytics-title="ipad">iPad</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/iphone/" data-analytics-title="iphone">iPhone</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/watch/" data-analytics-title="watch">Watch</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/apple-vision-pro/" data-analytics-title="vision">Vision</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/airpods/" data-analytics-title="airpods">AirPods</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/tv-home/" data-analytics-title="tv and home">TV &amp; Home</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/airtag/" data-analytics-title="airtag">AirTag</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/us/shop/goto/buy_accessories" data-analytics-title="accessories">Accessories</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/us/shop/goto/giftcards" data-analytics-title="gift cards">Gift Cards</a></li>
      					</ul>
      				</div>
      				<div className="ac-gf-directory-column-section">
      					<h3 className="ac-gf-directory-column-section-title">
      					...
      					<ul id="footer-directory-column-section-applewallet" className="ac-gf-directory-column-section-list" role="list">
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/wallet/" data-analytics-title="wallet">Wallet</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/apple-card/" data-analytics-title="apple card">Apple&nbsp;Card</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/apple-pay/" data-analytics-title="apple pay">Apple&nbsp;Pay</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/apple-cash/" data-analytics-title="apple cash">Apple&nbsp;Cash</a></li>
      					</ul>
      				</div>
      			</div>
      			<div className="ac-gf-directory-column">
      				<div className="ac-gf-directory-column-section">
      					...
      					<ul id="footer-directory-column-section-accounts" className="ac-gf-directory-column-section-list" role="list">
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="https://account.apple.com/" data-analytics-title="apple account" data-analytics-exit-link="">Manage Your Apple Account</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/us/shop/goto/account" data-analytics-title="apple store account">Apple Store Account</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="https://www.icloud.com" data-analytics-title="icloud.com" data-analytics-exit-link="">iCloud.com</a></li>
      					</ul>
      				</div>
      				<div className="ac-gf-directory-column-section">
      					<h3 className="ac-gf-directory-column-section-title">
      					...
      					<ul id="footer-directory-column-section-entertainment" className="ac-gf-directory-column-section-list" role="list">
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/apple-tv-plus/" data-analytics-title="apple tv plus">Apple&nbsp;TV+</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/apple-music/" data-analytics-title="apple music">Apple&nbsp;Music</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/apple-arcade/" data-analytics-title="apple arcade">Apple&nbsp;Arcade</a></li>
      						<li className="ac-gf-directory-column-section-item" role="listitem"><a className="ac-gf-directory-column-section-link" href="/fitness/" data-analytics-title="fitness">Apple&nbsp;Fitness+</a></li>
      					</ul>
      				</div>
      			</div>
      		</nav>
